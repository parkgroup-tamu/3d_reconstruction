...
class Extractxyz:
    ...
    def launch(path, ifilename, ofilename, a, lr):
        cap = cv2.VideoCapture(path + ifilename)
        time.sleep(2.0)
        
        cv2.namedWindow("Trackbars")
        cv2.createTrackbar("L-B","Trackbars", 120, 255, Extractxyz.nothing) #90 #normal: 120
        cv2.createTrackbar("L-G","Trackbars", 120, 255, Extractxyz.nothing) #90 #120
        cv2.createTrackbar("L-R","Trackbars", lr, 255, Extractxyz.nothing) #150 #90
        cv2.createTrackbar("U-B","Trackbars", 255, 255, Extractxyz.nothing)
        cv2.createTrackbar("U-G","Trackbars", 255, 255, Extractxyz.nothing)
        cv2.createTrackbar("U-R","Trackbars", 255, 255, Extractxyz.nothing)
        ...
        np.savetxt(path + ofilename + ".csv", centroid_list,delimiter=",", fmt='%s')
